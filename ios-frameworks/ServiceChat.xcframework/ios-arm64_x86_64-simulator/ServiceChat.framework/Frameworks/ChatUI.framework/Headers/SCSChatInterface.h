...
@protocol SCSChatInterfaceDelegate;
...
/// Execute this method to minimize the chat interface.
/// This is an idempotent operation.
- (void)minimize;

/// Execute this method to maximize the chat interface.
/// This is an idempotent operation.
- (void)maximize;

/// Event delegate for listening to events emitted by the SCSChatInterface
@property (nonatomic, readwrite, weak, nullable) id<SCSChatInterfaceDelegate> delegate;
